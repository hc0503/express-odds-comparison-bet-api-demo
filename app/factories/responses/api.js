...
/*
	...
	If error is present, data can be null (But it's not required).
*/
function _createGenericResponse(options = { res: null, status: 200, data: {}, error: null, format: FORMATS.JSON }) {
	try {
		const data = {
